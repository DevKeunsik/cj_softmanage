                        ...
                        <form class="form-validate form-horizontal" method="post" action=""
                            ...
                            <div class="form">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        <textarea class="form-control " id="target" name="target" ><?php echo $views -> target;?></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label for="serial_num" class="col-lg-2 control-label">시리얼번호</label>
                                    <div class="col-lg-10">
                                        <textarea class="form-control " id="serial_num" name="serial_num" ><?php echo $views -> serial_num;?></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="package" class="col-lg-2 control-label" name="package">패키지 유/무</label>
                                    <div class="col-lg-10">
                                        <input type="checkbox" name="package" value="<?php echo $views -> package;?>"> 패키지 있으면 선택하세요
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        <input type="text" class="form-control" id="use_num" name="use_num" value="<?php echo $views -> use_num;?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-actions">
                                    <div class="col-lg-10 col-lg-offset-2">
                                        ...
                                        <a href="/soft/soft_progress_delete/<?php echo $this -> uri -> segment(3); ?>"
