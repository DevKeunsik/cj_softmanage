    ...
    <section class="wrapper">
        <div class="row">
            <div class="col-lg-12">
                ...
                <ol class="breadcrumb">
                    <li><i class="icon_document_alt"></i>소프트웨어</li>
                    <li><i class="fa fa-files-o"></i>진행</li>
                </ol>
            </div>
        </div>
        <div class="row">
                        ...
                        <div class="form">
                            <form class="form-validate form-horizontal" method="post" action="" id="write_action">
                                <div class="form-group">
                                    <label for="product_name" class="control-label col-lg-2">제품명</label>
                                    <div class="col-lg-10">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        <textarea class="form-control " id="serial_num" name="serial_num" ></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
