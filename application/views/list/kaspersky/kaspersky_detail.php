                        ...
                        <form class="form-validate form-horizontal" method="post" action=""
                            ...
                            <div class="form">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-10">
                                        <input type="text" class="form-control" id="duration" name="duration" value="<?php echo $views -> duration;?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label for="serial_num" class="col-lg-2 control-label">시리얼번호</label>
                                    <div class="col-lg-10">
                                        <input type="text" class="form-control" id="serial_num" name="serial_num" value="<?php echo $views -> serial_num;?>">
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-actions">
                                    <div class="col-lg-10 col-lg-offset-2">
                                        ...
                                        <a href="/soft/kaspersky_delete/<?php echo $this -> uri -> segment(3); ?>"
