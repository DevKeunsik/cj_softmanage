...
<section id="main-content">
    <section class="wrapper">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h3 class="page-header"><i class="fa fa-laptop"></i> 전산실보관 마우스</h3>
                <?php
                ...
                ?>
                <div class="btn-group">
                    <a class="btn btn-default" href="" title="현재페이지">마우스</a>
                                    ...
                                    <div class="btn-group">
                                        ...
                                        if ( $this -> session -> userdata('user_level') == '1') {
                                            ...
                                            <a class="btn btn-danger btn-sm"
                                               href="/group/jeonsan_mouse_delete/<?php echo $lt->j_idx; ?>">삭제</a>
                                            <?php
                                        }
                                        ?>
                                    </div>
